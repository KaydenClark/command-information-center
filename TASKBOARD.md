...
| [S-006](specs/S-006-captain-workbench-release-handoff/SPEC.md) | TK-001: Credential-free Captain release handoff and reconciliation (in-progress) | CIC Engineer | none | Draft PR 18 is open to `Integration` from the remotely recovered handoff branch; no merge is authorized. | Obtain independent immutable-head review of the final published head before Integration. |
<!-- hot-specs:end -->
