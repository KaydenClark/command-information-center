...
| [S-024](specs/S-024-daily-project-slice-receipts/SPEC.md) | TK-002: Render one compact receipt card per enrolled project in the Projects view, with desktop/mobile visual proof and explicit unavailable fields. (in-progress) | codex | none | TK-002 claimed by codex. | Close TK-002 with verification and documentation proof. |
