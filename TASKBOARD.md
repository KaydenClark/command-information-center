...
|---|---|---|---|---|---|
| [S-027](specs/S-027-foundry-control-surface-v1-0-1/SPEC.md) | TK-007: Run the full green gate, obtain independent immutable-SHA review, publish the producer checkpoint, install the exact reviewed build into the Module product, restart port 8787, and prove authenticated desktop/mobile production behavior and deployment provenance. (ready) | Codex | none for TK-001; live Job Order animation remains a separate future capability blocked by the Grounding Journal, Gatehouse/Sandcastle receipts, and Announced Activation. | TK-006 closed with proof. | Complete TK-007. |
| [S-028](specs/S-028-fuid-work-item-projection-and-intent/SPEC.md) | TK-001: Add the reviewed additive tables and deterministic transactional rebuild with red/green schema, provenance, uniqueness, rollback, and idempotency tests. (ready) | Codex | root S-036/TK-003 canonical capture contract | Kayden authorized the additive SQLite Projection/Intent design and grouped kanban implementation. | TK-001 — implement the reviewed additive SQLite schema and deterministic projection rebuild. |
