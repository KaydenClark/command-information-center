...
| [S-009](specs/S-009-stable-project-numbers/SPEC.md) | TK-001: Assign stable project IDs and render composite project/spec references (in-progress) | Codex | none | All immutable-review findings were fixed through focused red/green tests and the full root/CIC gates. | Publish the fixed checkpoints and re-review the exact heads. |
<!-- hot-specs:end -->
