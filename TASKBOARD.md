...
| [S-006](specs/S-006-captain-workbench-release-handoff/SPEC.md) | TK-001: Credential-free Captain release handoff and reconciliation (in-progress) | CIC Engineer | none | Cross-contract hardening repairs and full gates are green; publication to draft PR 18 is in progress. | Obtain independent immutable-head review of the final published head before Integration. |
<!-- hot-specs:end -->
