...
| 000003 | [S-028](specs/S-028-fuid-work-item-projection-and-intent/SPEC.md) | 00000D / TK-001: Add the reviewed additive tables and deterministic transactional rebuild with red/green schema, provenance, uniqueness, rollback, and idempotency tests. (ready) | Codex | none | 2026-08-18 | Root S-036/TK-003 delivered canonical FUID/date capture; TK-001 is ready. | TK-001 — implement the reviewed additive SQLite schema and deterministic projection rebuild. |
