...
| [S-023](specs/S-023-openbrain-answer-quality/SPEC.md) | TK-001: Pass the operator's actual question through the CIC Intelligence server boundary to the OpenBrain request adapter. (in-progress) | codex | none for the deterministic request/synthesis seams; live provider proof remains separately credential-gated. | TK-001 claimed by codex. | Close TK-001 with verification and documentation proof. |
