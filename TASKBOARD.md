...
| [S-012](specs/S-012-canonical-project-interaction/SPEC.md) | TK-002: Fail closed on direct priority writes to adopted generated Taskboards (in-progress) | CIC Engineer | TK-001 | TK-002 implementation checkpoint makes adopted and legacy direct Taskboard priority writes fail closed with byte-invariance proof. | Run exact-head Auditor review, resolve any findings, then close TK-002. |
