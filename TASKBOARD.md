...
| [S-023](specs/S-023-foundry-harness-flow/SPEC.md) | TK-003: Add a portfolio summary of the same canonical flow evidence. (blocked) | CIC Engineer | owner review | TK-001 and TK-002 delivered fixture-driven on `feature/foundry-harness-flow` per owner direction to not wait for the live Audit Engine reader. | Owner review of the fixture-driven Harness view, then the small reader-adapter swap when Audit Engine S-003 publishes the sanitized export contract. |
