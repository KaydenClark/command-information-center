...
| [S-023](specs/S-023-openbrain-answer-quality/SPEC.md) | TK-001: Pass the operator's actual question through the CIC Intelligence server boundary to the OpenBrain request adapter. (ready) | CIC Engineer | none for the deterministic request/synthesis seams; live provider proof remains separately credential-gated. | Promoted the CIC-owned Phase-1 repair from the 2026-07-17 OpenBrain grilling. | Claim TK-001 and drive the actual-question request seam red/green. |
