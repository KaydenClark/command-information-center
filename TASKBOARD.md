...
| [S-006](specs/S-006-captain-workbench-release-handoff/SPEC.md) | TK-001: Credential-free Captain release handoff and reconciliation (in-progress) | CIC Engineer | none | Final local gates and cross-contract worker tests are green; no real worker, credential, runtime, database contents, GitHub mutation, or live merge was used. | Publish the exact remote checkpoint and draft Integration PR, then obtain independent immutable-head review before Integration. |
<!-- hot-specs:end -->
