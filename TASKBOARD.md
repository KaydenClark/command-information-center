...
| 000003 | [S-028](specs/S-028-fuid-work-item-projection-and-intent/SPEC.md) | 00000G / TK-004: Run full API/UI/browser proof, document one-command rebuild/demo/recovery, and checkpoint the exact remote head for root S-036 acceptance. (blocked) | Codex | TK-003 | 2026-08-18 | TK-003 closed with proof. | Complete TK-004. |
