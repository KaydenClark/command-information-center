...
| 000003 | [S-028](specs/S-028-fuid-work-item-projection-and-intent/SPEC.md) | 00000F / TK-003: Replace the flat read-only Master Taskboard with the Spec-grouped five-column Projection view, FUID/alias/dates/search, and drag/drop pending Intent overlay. (ready) | Codex | TK-002 | 2026-08-18 | TK-002 closed with proof; TK-003 is ready after its dependency passed. | Complete TK-003. |
