...
| [S-023 - OpenBrain Answer Quality](specs/S-023-openbrain-answer-quality/SPEC.md) | Make CIC send the operator's real question to OpenBrain and synthesize an answer rather than a raw activity dump. | active |
<!-- spec-catalog:end -->
