...
const SENSITIVE_PATTERNS = [
  /\b(robinhood|rocketmoney|bank|banking|financials?|finance|tax(?:es)?|1099|statement|staking|earnings?|balance|account\s+disconnected)\b/i,
  /\b(bought|buy|purchase|purchased|ordered|order\s+(?:confirmation|placed)|delivered|delivery|receipt|invoice|amazon|google\s+play|galaxy\s+(?:tab|s10\+?)|samsung\s+sm-x820|new\s+tablet)\b/i,
